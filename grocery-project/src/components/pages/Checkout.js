...
import {makePayment} from "../../context/Database";
...
export default function Checkout() {
    ...
    useEffect(() => {
            ...
            setItems(cart)
            let t = 0
            items.forEach(item => t = t + item.pricePerDay)
            setTotal(t)
            setTax(t * 0.3)
	 setTax(location.state.pricePerDay * 0.3)
        }, [])
                    ...
                    <div className="m-modal-content">
                        ...
                        <div style={{width:"100%", height:"55vh", marginTop:"30px", display:"block"}}>
                            <div>
                                ...
                                <hr/>
                                <p>Cost:  <span className="price" style={{color: "black"}}><b>${total}/Per day</b></span></p>
                                <p>Tax:  <span className="price" style={{color: "black", fontSize:"12px"}}><b>${tax}</b></span></p>
                                <p>Total:  <span className="price" style={{color: "black"}}><b>${items[0].total}/Per day<br/>  ${items[0].pricePerDay}/Per Week</b></span></p>
                    ...
                    <div className="check-out-col-25">
                        <div className="checkout-container">
                            ...
                            {items.map((item) => {
                                return (<div key={item.title}>
                                    <p><a href="#">{item.title}</a><span
                                        className="price" style={{fontSize:12}}>${item.pricePerDay}/daily </span></p>
                                </div>)
                            })
                            }
                            <hr/>
